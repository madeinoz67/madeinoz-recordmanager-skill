...
Your task:
1. Retrieve expected tags for this entity type from TaxonomyExpert
2. Compare expected vs actual tags on entity documents
3. Identify missing tags that should be applied
4. Identify incorrect/deprecated tags to remove
5. Check document type consistency
6. Analyze naming convention compliance
7. Score taxonomy health (0-100)
...
Your task:
1. Check retention requirements for each document type
2. Identify documents approaching retention deadlines
3. Identify documents past retention (safe to delete)
4. Check for required documents that are missing
5. Verify FTE retention for family trusts
6. Check pre-EOFY requirements for trusts
7. Score retention compliance (0-100)
