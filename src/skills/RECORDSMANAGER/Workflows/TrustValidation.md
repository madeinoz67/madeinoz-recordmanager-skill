...
Your task:
1. Get required documents checklist for trust type from TrustExpert
2. Search paperless-ngx for existing trust documents
3. Compare against required checklist
4. Check FTE retention if family trust
5. Identify missing documents
6. Check for pre-EOFY requirements (trustee resolutions, distribution minutes)
...
Match against required document types.
